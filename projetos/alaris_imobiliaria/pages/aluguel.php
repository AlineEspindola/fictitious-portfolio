...
$sql="SELECT i.id, i.nome, i.descricao, i.valor, i.quantidade_curtidas, m.nome AS cidade FROM imovel i, municipio m WHERE i.municipio_id=m.id AND finalidade='aluguel' ORDER BY i.quantidade_curtidas DESC";
...
foreach($imoveis as $i){
    ...
    echo '<a href="actions/curtir_aluguel.php?id='.$i['id'].'"><img class="coracao" src="images/coracao.png" alt="coração"></a>';
    echo '</div>';
